 ...
 */
class tx_enetcacheanalytics_performance_backend_RedisBackendRedisCache extends tx_enetcacheanalytics_performance_backend_AbstractBackend {
	/**
	 * Redis Daemon server
	 */
